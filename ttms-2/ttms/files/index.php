...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/background.png" alt="Chania">
        </div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BCA I SEMESTER</option>
            <option value="4"> BCA II SEMESTER</option>
            <option value="5">BCA III SEMESTER</option>
            <option value="6"> BCA IV SEMESTER</option>
            <option value="7"> BCA V SEMESTER</option>
            <option value="8"> BCA VI SEMESTER</option>
        </select>
        <button type="submit" class="btn btn-info btn-lg" style="margin-top: 10px">Student Login</button>
    </form>
</div>
<!-- The Modal -->
